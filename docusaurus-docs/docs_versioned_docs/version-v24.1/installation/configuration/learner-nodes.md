...
---
:::note
**Enterprise Feature**: Learner node requires a Dgraph Enterprise license. See [License](../../admin/enterprise-features/license) for details.
:::

A Learner node allows a user to spin-up a read-only replica instance across the world without paying a latency cost. 
