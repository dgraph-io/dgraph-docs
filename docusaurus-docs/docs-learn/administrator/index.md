...
- Get familiar with some terms in the [Glossary]([dgraph-glossary](dgraph-glossary))

- **Dgraph Community and Dgraph Enterprise** (self-managed)
  - Refer to [Installation]([installation](installation)) to learn how to deploy and manage Dgraph database in a variety of self-managed deployment scenarios.
  - [Dgraph Administration]([admin](admin)) describes the admin operations.
