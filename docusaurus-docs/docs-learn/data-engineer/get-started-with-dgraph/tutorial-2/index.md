...
In the [previous tutorial]([tutorial-1/index](tutorial-1/index)) of getting started,
...
Refer to the [previous tutorial]([tutorial-1/index](tutorial-1/index)) if you have questions related to the structure of the query in general.
...
Check out our next tutorial of the getting started series [here]([tutorial-3/index](tutorial-3/index)).
