...
Aggregation can only be applied to [value variables](variables#value-variables).  An index is not required (the values have already been found and stored in the value variable mapping).
