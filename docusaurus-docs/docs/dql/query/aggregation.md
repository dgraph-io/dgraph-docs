...
Aggregation can only be applied to [value variables](/dgraph-overview/variables#value-variables).  An index is not required (the values have already been found and stored in the value variable mapping).
