...
For example, many of the previous examples could be replaced entirely using [`var` blocks](/dgraph-overview/dql-query#var-block) instead of utilizing `@cascade`.
