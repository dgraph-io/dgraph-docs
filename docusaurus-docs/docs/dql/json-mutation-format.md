...
Dgraph supports [Mutations](/dgraph-overview/dql/dql-mutation) in JSON or [RDF](/dgraph-overview/dql/dql-rdf) format.
...
- the type is defined in the [Dgraph types schema](/dgraph-overview/dql/dql-schema)
