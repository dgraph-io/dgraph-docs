...
For description of the various flags in the migration tool, see [command line options](/dgraph-overview/migration/import-data).
:::
...
The two files can then be imported into Dgraph using the [Dgraph Live Loader](/dgraph-overview/migration/live-loader)
or [Bulk Loader](/dgraph-overview/migration/bulk-loader). Sometimes you might want to customize your schema.
