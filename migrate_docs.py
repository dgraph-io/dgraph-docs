#!/usr/bin/env python3
"""
Script to migrate Hugo docs pages (type="docs") to Docusaurus format.
...
def convert_shortcodes(content):
    ...
    # Pattern: {{< relref "path" >}} or {{< relref "path.md" >}}
...
def main():
    ...
    docusaurus_dir = Path('docusaurus-docs/docs')
    
    # Find all files with type="docs"
    migrated = 0
    skipped = 0
