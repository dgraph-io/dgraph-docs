...
{{% notice "note" %}}
**Enterprise Feature**: Audit logging requires a Dgraph Enterprise license. See [License]({{< relref "license.md" >}}) for details.
{{% /notice %}}
...
For general logging and log format information, see [Log Format]({{< relref "log-format.md" >}}).
