...
| Data loading     | [`bulk`](#dgraph-bulk) | Dgraph [Bulk Loader]({{< relref "howto/importdata/bulk-loader.md" >}}) commands     |
| Data loading     | [`live`](#dgraph-live) | Dgraph [Live Loader]({{< relref "howto/importdata/live-loader.md" >}}) commands     |
...
[Bulk Loader]({{< relref "howto/importdata/bulk-loader.md"  >}}) tool.
...
This command is used to load live data with the Dgraph [Live Loader]({{< relref "howto/importdata/live-loader.md" >}}) tool.
