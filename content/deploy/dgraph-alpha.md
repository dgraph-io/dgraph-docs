...
* `/admin/shutdown` initiates a proper [shutdown]({{< relref "deploy/admin/dgraph-administration.md#shutting-down-database" >}}) of the Alpha.
* `/admin/export` initiates a data [export]({{< relref "deploy/admin/dgraph-administration.md#exporting-database" >}}). The exported data will be
