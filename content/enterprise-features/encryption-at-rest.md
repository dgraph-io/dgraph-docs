...
[export the database]({{< relref "deploy/dgraph-administration.md#export-database" >}}) and [fast data load]({{< relref "howto/importdata/overview.md" >}}),
preferably using the [bulk loader]({{< relref "howto/importdata/bulk-loader.md" >}}).
{{% /notice %}}
