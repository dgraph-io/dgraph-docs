...
The `--vault` superflag specifies the [Hashicorp Vault](https://www.vaultproject.io/) server address, role id, secret id and field that contains the encryption key that was used to encrypt the backup.
