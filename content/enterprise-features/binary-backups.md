...
the backup. Unlike [exports]({{< relref "deploy/admin/dgraph-administration.md#exporting-database" >}}),
...
[whitelisted for admin operations]({{< relref "deploy/admin/dgraph-administration.md#whitelisting-admin-operations" >}}).
