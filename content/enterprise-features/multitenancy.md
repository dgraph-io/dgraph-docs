...
All other `drop` operations run at namespace level and are namespace specific. For information about other delete options, see [delete](https://dgraph.io/docs/mutations/delete/). 
