...
<div class="landing">
  <div class="hero">
    ...
    <p><b>Tip</b>: New to Dgraph? Take the <a href="https://dgraph.io/tour">Dgraph Tour</a> to run live queries in your browser. Then, try Dgraph as a <a href="https://cloud.dgraph.io">cloud service</a>, or install Dgraph on a <a href="https://dgraph.io/docs/deploy/single-host-setup/">single host</a> or <a href="https://dgraph.io/docs/deploy/cluster-setup/">cluster</a>.</p>
